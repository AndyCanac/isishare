            ...
            <div className="px-6 py-4">
                {contacts.map(contact => (
                    <div key={contact} className="flex items-center justify-between">
                        ...
                        >
                            <MdDeleteForever size={30} style={{ color: "black", marginLeft: "5px" }} />
                        </button>
                    </div>
                ))}
            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                <button onClick={() => setShowAdd(true)} className="px-6 py-2 mx-auto tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-md hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
        Ajouter un contact
    </button>
            </div>
        </div>
