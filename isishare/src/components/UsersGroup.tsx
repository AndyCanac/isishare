    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const groupResponse = await fetch(`${localStorage.getItem("api")}groups/id/${localStorage.getItem("idTargetGroup")}`);
                ...
                const filteredUser_group = user_groupData.filter((group: any) => group.group_id == group_id);
                ...
                const userGroupIdsArray = filteredUser_group.map((userGroup: any) => userGroup.user_id);
