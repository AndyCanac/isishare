...
const Groups = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const groupsResponse = await fetch(`${localStorage.getItem("api")}groups`);
                const groupsData = await groupsResponse.json();
                const sortedGroups = groupsData.sort((a: any, b: any) => a.name.localeCompare(b.name));
                ...
                const user_groupResponse = await fetch(`${localStorage.getItem("api")}user_group`);
    ...
    const groupsGroup2 = filteredGroups.filter((groups, index) => index % 3 === 1);
    const groupsGroup3 = filteredGroups.filter((groups, index) => index % 3 === 2);
                                            ...
                                            >
                                                ...
                                                <td className="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div key={group.id} className="flex justify-center">
                                                        <a href="#" role="link">
                                                            <Image src={"/" + getInterestIcon(group.interest)} alt="Icone de l'intérêt" className="small-icon-tree" width={200} height={200} />
                                                        </a>
                                                    </div>
                                                </td>
                                                <td></td>
                        ...
                        <div className="parent ml-14">
                            <div className="div1">
                                {groupsGroup1.map((group, index) => (
                                    <div key={index}>
                                        <div className="hover:bg-light-blue-transparent hover:text-white cursor-pointer transition duration-300 w-full max-w-md px-8 py-4 mt-16 bg-white rounded-lg shadow-lg" onClick={() => setIdGroup(group.id)}>
                                            ...
                                            <div className="flex justify-between mt-6">
                                                ...
                                                <div key={group.id} className="flex-1 min-h-7">
                                                    <a href="#" role="link">
                                                        <Image src={"/" + getInterestIcon(group.interest)} alt="Icone de l'intérêt" className="small-icon-kanban" width={200} height={200} />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
