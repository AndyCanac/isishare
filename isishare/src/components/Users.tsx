                ...
                <table className="max-w-1xl divide-y divide-dark-gray td-width">
                  ...
                  <tbody className="divide-y divide-light-gray bg-white text-black ">
                    {filteredUsers.map((user) => (
                      <tr
                        className="hover:bg-light-blue-transparent cursor-pointer transition duration-300"
                        onClick={() => setIdUser(user.idUser)}
                      >
                        <td className="px-4 py-4 text-sm font-medium whitespace-nowrap">
                          {user.nameUser}
                        </td>
                        <td className="px-4 py-4 text-sm   whitespace-nowrap">
                          {user.descriptionConnaissance}
                        </td>
                        <td className="px-4 py-4 text-sm   whitespace-nowrap">
                          {user.descriptionObjectif}
                        </td>
                        <td className="px-4 py-4 text-sm   whitespace-nowrap">
                          {user.pointsUser}
                        </td>
              ...
              <div>
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-gray-600">
                    {" "}
                    Connaissances : {user.descriptionConnaissance}
                  </p>

                  <div className="flex justify-end mt-4">
                    <a href="#" className="text-lg font-medium" role="link">
                      Points : {user.pointsUser}
                    </a>
                  </div>
                </div>
              </div>
